/**
 * Assignment: Week 3 
 * File: cs520.hw3.part1
 * MET CS520 
 * Name: Andrew Taliercio
 * Email: andy.taliercio@hotmail.com / ajtalie@bu.edu
 * Description: This package implements the JOptionPane to demonstrate the manipulation of data as strings and numerics.
 * Also demonstrates error handling and graceful failure of a program.
 *  */
	...
	public static void main(String[] args) {
		...
		try {
			...
			// the end.
				...
				// Using this value, extract the age part of the input using the substring method.
